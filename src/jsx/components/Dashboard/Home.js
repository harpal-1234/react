    ...
    <>
      <div className="form-head d-flex mb-3 align-items-start">
        <div className="mr-auto d-none d-lg-block">
          ...
          <p className="mb-0">Welcome to Train Tab Admin!</p>
        </div>
              ...
              <div className="media ai-icon">
                ...
                <div className="media-body">
                  <h3 className="mb-0 text-black">
                    <span className="counter ml-0">
                      {" "}
                      <CountUp start={0} end={programArticle} duration={5} />
                    </span>
                  </h3>
                  <p className="mb-0">Total Article</p>
                  <small>(Program)</small>
                </div>
              </div>
            </div>
              ...
              <div className="media ai-icon">
                ...
                <div className="media-body">
                  <h3 className="mb-0 text-black">
                    <span className="counter ml-0">
                      {" "}
                      <CountUp start={0} end={tipsArticle} duration={5} />
                    </span>
                  </h3>
                  <p className="mb-0">Total Article</p>
                  <small>(Tips)</small>
